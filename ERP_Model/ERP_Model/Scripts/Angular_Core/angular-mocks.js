 ...
 */
    ...
    angular.mock.$Browser = function() {
        ...
        self.defer.cancel = function(deferId) {
            ...
            angular.forEach(self.deferredFns,
                function(fn, index) {
        ...
        this.$get = function() {
            ...
            $log.assertEmpty = function() {
                ...
                angular.forEach(["error", "warn", "info", "log", "debug"],
                    function(logLevel) {
                        angular.forEach($log[logLevel].logs,
                            function(log) {
                                angular.forEach(log,
                                    function(logItem) {
                                        errors.push("MOCK $log (" +
                                            logLevel +
                                            "): " +
                                            String(logItem) +
                                            "\n" +
 ...
 */
    angular.mock.TzDate = function(offset, timestamp) {
        ...
        if (self.toISOString) {
            self.toISOString = function() {
                return padNumberInMock(self.origDate.getUTCFullYear(), 4) +
                    ...
                    "-" +
                    padNumberInMock(self.origDate.getUTCDate(), 2) +
                    "T" +
                    ...
                    "." +
                    padNumberInMock(self.origDate.getUTCMilliseconds(), 3) +
                    "Z";
            };
        }
        ...
        angular.forEach(unimplementedMethods,
            function(methodName) {
    ...
    angular.mock.animate = angular.module("ngAnimateMock", ["ng"])
        .config([
            "$provide", function($provide) {
                ...
                $provide.factory("$$animateAsyncRun",
                    function() {
                        var queue = [];
 ...
 */
    function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
        ...
        function createShortMethods(prefix) {
            angular.forEach(["GET", "DELETE", "JSONP", "HEAD"],
                function(method) {
            ...
            angular.forEach(["PUT", "POST", "PATCH"],
                function(method) {
    ...
    function MockHttpExpectation(method, url, data, headers, keys) {
        ...
        this.params = function(u) {
            ...
            function parseQuery() {
                ...
                angular.forEach(queryStr.split("&"),
                    function(keyValue) {
                        if (keyValue) {
    ...
    function MockXhr() {
        ...
        this.getResponseHeader = function(name) {
            ...
            header = undefined;
            angular.forEach(this.$$respHeaders,
 ...
 */
    angular.mock.$ComponentControllerProvider = [
        "$compileProvider", function($compileProvider) {
            this.$get = [
                "$controller", "$injector", "$rootScope", function($controller, $injector, $rootScope) {
                    return function $componentController(componentName, locals, bindings, ident) {
                        ...
                        var candidateDirectives = directives.filter(function(directiveInfo) {
                            ...
                            return directiveInfo.controller &&
                        ...
                        return $controller(directiveInfo.controller,
                            locals,
                            bindings,
    ...
    !(function(jasmineOrMocha) {
        ...
        module.$$beforeEach = function() {
            if (injectorState.shared && currentSpec && currentSpec != this) {
                ...
                currentSpec = this;
                angular.forEach(["$injector", "$modules", "$providerInjector", "$injectorStrict"],
                    function(k) {
        ...
        module.$$cleanup = function() {
            ...
            angular.forEach(currentSpec.$modules,
                function(module) {
            ...
            angular.forEach(angular.element.fragments,
                function(val, key) {
            ...
            angular.forEach(angular.callbacks,
                function(val, key) {
