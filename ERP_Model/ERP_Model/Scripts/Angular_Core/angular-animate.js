    ...
    "$animateProvider", function($animateProvider) {
        ...
        this.$get = [
            ...
            function($$rAF,
                ...
                var contains = window.Node.prototype.contains ||
                    function(arg) {
                        ...
                        forEach(groupedAnimations,
                            function(animationEntry) {
                                toBeSortedAnimations.push({
                                    domNode: getDomNode(animationEntry.from
...
var ngAnimateSwapDirective = [
    "$animate", "$rootScope", function($animate, $rootScope) {
        return {
            restrict: "A",
            transclude: "element",
            terminal: true,
            ...
            link: function(scope, $element, attrs, ctrl, $transclude) {
                ...
                scope.$watchCollection(attrs.ngAnimateSwap || attrs["for"],
                    function(value) {
                        if (previousElement) {
